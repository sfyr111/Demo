  ...
  .bulletin {
    ...
    .supports {
      ...
      .icon {
        ...
        &.discount {
          background-image: url('./seller/discount_4@3x.png')
        }
        &.special {
          background-image: url('./seller/special_4@3x.png')
        }
        &.invoice {
          background-image: url('./seller/invoice_4@3x.png')
        }
        &.guarantee {
          background-image: url('./seller/guarantee_4@3x.png')
        }
      }
      .text {
        font-size: 12px;
